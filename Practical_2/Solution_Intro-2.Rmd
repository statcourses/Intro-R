...
`attach()` and `detach()` add and remove a data object to and from the R search path making it unnecessary and compulsory respectively to specify the dataset name whenever\\n you need to call one of its variables
